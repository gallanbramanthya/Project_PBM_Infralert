...
class FormPenerangan extends StatefulWidget {
  const FormPenerangan({super.key});
  ...
  Future<void> submitForm() async {
    ...
    try {
      await FirebaseFirestore.instance
        ...
        'status': 'Dalam proses',
        'category': 'Lampu dan Penerangan',
        'imageLink':
            'https://firebasestorage.googleapis.com/v0/b/infralert-9193c.appspot.com/o/form%2Flampu2.png?alt=media&token=c89d6a36-6573-4536-a0e0-4f6d73effed4',
      });
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      WidgetTextField(
                        title: 'Judul',
                        hintText: 'e. g. Lampu Lalu Lintas Mati',
                        controller: titleController,
                      ),
                      SizedBox(height: 12),
                      WidgetTextField(
                        title: 'Keluhan',
                        hintText: 'e. g. Membuat lalu lintas tidak teratur',
                      ...
                      WidgetTextField(
                        title: 'Lokasi',
                        hintText: 'e. g. Lampu lalu lintas Biostec',
