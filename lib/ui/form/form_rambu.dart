...
class FormRambu extends StatefulWidget {
  const FormRambu({super.key});

  @override
  State<FormRambu> createState() => _FormRambuState();
}

class _FormRambuState extends State<FormRambu> {
  ...
  Future<void> submitForm() async {
    ...
    try {
      await FirebaseFirestore.instance
        ...
        'category': 'Rambu',
        'imageLink':
            'https://firebasestorage.googleapis.com/v0/b/infralert-9193c.appspot.com/o/form%2Frambu.png?alt=media&token=4c0add9c-55dd-4cc1-bc01-4a2a171ea0bc',
      });
          ...
          return AlertDialog(
            ...
            actions: [
              TextButton(
                ...
                child: Text(
                  'OK',
                  style: GoogleFonts.poppins(color: primaryBase),
                ),
              ),
            ],
          );
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      WidgetTextField(
                        title: 'Judul',
                        hintText: 'e. g. Rambu patah',
                        controller: titleController,
                      ),
                      SizedBox(height: 12),
                      WidgetTextField(
                        title: 'Keluhan',
                        hintText: 'e. g. Membuat pengendara bingung',
                      ...
                      WidgetTextField(
                        title: 'Lokasi',
                        hintText: 'e. g. Rambu putar balik depan gedung DPRD',
          ...
          child: Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                hintText: hintText,
                hintStyle: GoogleFonts.poppins(color: blackLight),
                filled: true,
                fillColor: whiteBase,
